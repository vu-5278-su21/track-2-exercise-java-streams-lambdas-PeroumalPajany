...
public class StreamUtils {
	 ...
	 *
	 * The function takes a "property function" as a parameter. The property
	 * function should return the property value associated with the object that
	 * should contribute to the average. For example, you could provide a function
	 * that extracts the heart rate data from a DataFrame.
	 *
	 * The function returns a new function that computes the average of a list of
	 * objects using the provided property function to extract a property value for
	 * each object.
	 *
